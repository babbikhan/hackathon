...
const ThreeSplitBanner = () => {
  ...
  return (
    <section className="max-w-screen-xl mx-auto text-left py-10">
      {/* Section Title */}
      <h2 className="text-3xl text-[#272343] font-semibold mb-9">Our Popular Products </h2>

      {/* Flexbox for Banners */}
      <div className="flex justify-between gap-4">
        {/* First Banner with larger size */}
        <div className="w-[630px] h-[375px] bg-[#ffffff]">
          <img
            src={banners[0].image}
            alt={banners[0].title}
        ...
        <div className="w-[305px] h-[375px] bg-[#ffffff]">
          <img
            src={banners[1].image}
            alt={banners[1].title}
            className="w-full h-full object-cover mb-4"
